/**
 * Local preview: theme, QueryClient, Redux, and MSW for API mocking.
 * MSW intercepts per-story handlers defined via parameters.msw.handlers.
 */
...
// Start MSW — must be called before any story renders.
...
// Wire MSW so per-story handlers (parameters.msw.handlers) are activated.
